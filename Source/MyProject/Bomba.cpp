...
ABomba::ABomba()
{
	...
	Root->OnComponentBeginOverlap.AddDynamic(this, &ABomba::OnOverlapBegin);
...
void ABomba::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp,
