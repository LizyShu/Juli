...
AMyHUD::AMyHUD() {
	...
	//static ConstructorHelpers::FObjectFinder<UTexture2D> Texture(TEXT("Texture2D'/Game/StarterContent/Textures/1.1'"));
...
void AMyHUD::DrawHUD() {
	...
	//DrawTexture(MyTexture, 200, 200, MyCharacter->GetLife(), MyTexture->GetSizeY(), 0, 0, MyCharacter->GetLife()*4, MyTexture->GetSizeY(),
